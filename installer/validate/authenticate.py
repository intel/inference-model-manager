...
print("DEX URL found :", dex_baseurl)
...
def authenticate(username, password, token=True, verify=False):
    params = {
        'client_id': 'example-app',
    ...
    resp = requests.get(urljoin(dex_baseurl, '/dex/auth'), params=params, verify=verify)
